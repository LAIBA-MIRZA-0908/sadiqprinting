                ...
                <div class="p-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div style="display:none;">
                            <label class="block text-sm font-medium text-gray-700 mb-2">JO No</label>
                ...
                <div class="table-responsive overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300" id="invoiceTable">
                        <thead class="bg-gray-50">
                            ...
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-20">Qty</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-20">Sqft</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-28">Rate</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-28">Total</th>
...
<div id="selectPOModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
  <div class="bg-white w-11/12 md:w-3/4 lg:w-1/2 rounded-lg shadow-lg">
    ...
    var row = '<tr id="invoiceRow-' + invoiceRowCount + '">' +
        ...
        '<td class="px-4 py-2"><input type="number" class="w-full px-2 py-1 border border-gray-300 rounded numeric-input width-input" step="any" value="0" onchange="calculateRowTotal($(this).closest(\'tr\'))"></td>' +
        '<td class="px-4 py-2"><input type="number" class="w-full px-2 py-1 border border-gray-300 rounded numeric-input height-input" step="any" value="0" onchange="calculateRowTotal($(this).closest(\'tr\'))"></td>' +
        ...
        '<td class="px-4 py-2"><input type="number" class="w-full px-2 py-1 border border-gray-300 rounded numeric-input sqft-input" step="any" value="0" readonly></td>' +
        '<td class="px-4 py-2"><input type="number" class="w-full px-2 py-1 border border-gray-300 rounded numeric-input rate-input" step="any" value="0" onchange="calculateRowTotal($(this).closest(\'tr\'))"></td>' +
        '<td class="px-4 py-2"><input type="number" class="w-full px-2 py-1 border border-gray-300 rounded numeric-input total-input" step="any" value="0" readonly></td>' +
        ...
        response.jobOrders.forEach((po) => {
          rows += `
            <tr>
              ...
              <td class="border p-2 text-center">
                <button class="bg-green-600 text-white px-3 py-1 rounded selectSinglePO" 
                  data-pono="${po.JobOrderNo}">Select</button>
              </td>
            </tr>`;
        });
...
$('#confirmSelectedPOs').on('click', function() {
  const selectedPOs = $('.poCheckbox:checked').map(function() { return $(this).val(); }).get();
