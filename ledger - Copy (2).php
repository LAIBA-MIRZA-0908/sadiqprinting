...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-8 no-print">
        ...
        <select id="accountSelect" class="select2 w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" multiple>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    accountSelect.addEventListener('change', function() {
        const accountIds = Array.from(this.selectedOptions).map(opt => opt.value);
        ...
        // ✅ Fetch for multiple accounts (you can handle array in backend)
        fetch(`ledger_ajax_handler.php?account_id=${accountIds.join(',')}`)
