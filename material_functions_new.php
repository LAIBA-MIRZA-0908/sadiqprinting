...
function getMaterials() {
    ...
    if (!$countResult) {
        sendJsonResponse(false, 'Database error in count query');
    }
    ...
    if (!$result) {
        sendJsonResponse(false, 'Database error in materials query');
    }
...
function createMaterial() {
    ...
    if (!$stmt) {
        sendJsonResponse(false, 'Database error in prepare check');
    }
    ...
    if (!$stmt) {
        sendJsonResponse(false, 'Database error in prepare insert');
    }
    ...
    if ($stmt->execute()) {
        ...
        sendJsonResponse(false, 'Failed to create material');
    }
}
...
function updateMaterial() {
    ...
    if (!$stmt) {
        sendJsonResponse(false, 'Database error in prepare check name');
    }
    ...
    if (!$stmt) {
        sendJsonResponse(false, 'Database error in prepare update');
    }
    ...
    if ($stmt->execute()) {
        ...
        sendJsonResponse(false, 'Failed to update material');
    }
}
...
function deleteMaterial() {
    ...
    if (!$stmt) {
        sendJsonResponse(false, 'Database error in prepare delete');
    }
    ...
    if ($stmt->execute()) {
        ...
        sendJsonResponse(false, 'Failed to delete material');
    }
}
?>