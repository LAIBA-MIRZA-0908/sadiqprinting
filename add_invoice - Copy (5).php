...
<body class="bg-gray-100">
    ...
    <div class="flex flex-wrap gap-2 items-end">
        ...
        <div class="flex flex-col w-80">
            ...
            <select id="CustomerID" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success) {
                    ...
                    // resetForm(); <-- ab saveAndPrint mein handle hoga
                } else {
                    alert('Error: ' + (data.message || 'Unknown error occurred'));
                    reject(data.message);
                }
