    ...
    <div class="lg:col-span-4">
        <div class="bg-white rounded-lg shadow-md">
            <div class="bg-green-600 text-white px-6 py-4 rounded-t-lg flex justify-between items-center">
                ...
                <!-- ✅ New Select PO button -->
<button type="button" id="selectPOBtn" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 ml-2">
    <i class="fas fa-file-import mr-1"></i> Select PO
</button>
            </div>
            <div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-4">
        ...
        <div class="  p-3 rounded-lg">
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-xs font-medium text-gray-700">Advance /Paid Amount</span>
                    <input type="number" id="Advance" class="w-32 px-3 py-2 border border-gray-300 rounded numeric-input text-sm text-right bg-gray-100" readonly step="100" value="0">
                </div>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-xs font-medium text-gray-700">GST Rate (%)</span>
                    <input type="number" id="GSTRate" class="w-32 px-3 py-2 border border-gray-300 rounded numeric-input text-sm text-right" step="100" value="0">
                </div>
                <div class="flex justify-between items-center">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <input type="number" id="NTRRate" class="w-32 px-3 py-2 border border-gray-300 rounded numeric-input text-sm text-right" step="100" value="0">
                    </div>
                    <div class="flex justify-between items-center">
...
<div id="selectPOModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
  <div class="bg-white w-11/12 md:w-3/4 lg:w-1/2 rounded-lg shadow-lg">
    <div class="flex justify-between items-center border-b px-5 py-3 bg-blue-600 text-white rounded-t-lg">
      <h3 class="text-lg font-semibold">Select Purchase Orders</h3>
      <button id="closePOModal" class="text-white hover:text-gray-300">&times;</button>
    </div>

    <div class="p-5">
      <input type="text" id="poSearch" placeholder="Search PO..." 
    ...
    success: function(response) {
      if (response.success && response.items.length > 0) {
        response.items.forEach(item => {
          ...
          lastRow.find('.job-no').val(item.JobOrderNo || '');
